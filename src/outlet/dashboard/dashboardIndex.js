                ...
                <div className="row mb-8">
                    <div className="col-md-12">
                        ...
                        <div
                            ...
                            style={{
                                backgroundImage: "url(../assets/images/slider/slider-image-1.jpg)",
                                ...
                                <div className="mt-4">
                                    ...
                                    <ul className="list-unstyled mb-0">
                                        <li className="mb-2">
                                            ...
                                            <span className="ms-1">
                  <span className="text-dark">Shippings $32.98</span> (2%)
                </span>
                                        </li>
                                        <li className="mb-2">
                                            <svg
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="mb-5">
                                        <div className="d-flex align-items-center justify-content-between">
                                            ...
                                            <span>
                  <span className="me-1 text-dark">$1,619</span> (8.6%)
                </span>
                                        </div>
                                        {/* main wrapper */}
                                        <div>
                                    ...
                                    <div className="mb-5">
                                        ...
                                        <div className="d-flex align-items-center justify-content-between">
                                            ...
                                            <span>
                  <span className="me-1 text-dark">$3,571</span> (86.4%)
                </span>
                                        </div>
                                        <div>
                                            {/* progressbar */}
                                            <div className="progress bg-info-soft" style={{ height: 6 }}>
                                                <div
                                    ...
                                    <div>
                                        ...
                                        <div className="d-flex align-items-center justify-content-between">
                                            ...
                                            <span>
                  <span className="me-1 text-dark">$3,430</span> (74.5%)
                </span>
                                        </div>
                                        <div>
                                            {/* progressbar */}
                                            <div className="progress bg-light-danger" style={{ height: 6 }}>
                                                <div
